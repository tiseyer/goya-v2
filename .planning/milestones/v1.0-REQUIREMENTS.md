# Requirements Archive: v1.0 User Settings
...
- [x] **SHELL-01**: Settings section is accessible at `app/settings/` with a sidebar navigation layout consistent with Admin Settings
- [x] **SHELL-02**: Sidebar lists four items in order: General, Subscriptions, Connections, Inbox
- [x] **SHELL-03**: Active sidebar item is visually highlighted to indicate current page
- [x] **SHELL-04**: Settings layout follows the same design tokens and component patterns as Admin Settings (`AdminShell.tsx`)
