...
- [x] **Phase 2: Settings Shell** - Build sidebar-navigated Settings layout at `app/settings/` matching Admin Settings (completed 2026-03-23)
...
**Plans**: 1 plan
Plans:
- [x] 02-01-PLAN.md — Build settings shell with sidebar navigation and stub pages
**UI hint**: yes
...
| 2. Settings Shell | 1/1 | Complete   | 2026-03-23 |
