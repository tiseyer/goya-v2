...
- [x] **PROD-01**: Admin can view all products in a table with columns: Checkbox, Name, Price, Type (recurring/one-off), Status pill (Published/Draft/Deleted), Sales count
