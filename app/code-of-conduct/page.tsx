    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-[#1B3A5C] pt-24 pb-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#A8C5D8] text-lg">Our shared commitment to a respectful and inclusive yoga community.</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 pb-24">
        <div className="space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Respectful Communication</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Inclusivity and Non-Discrimination</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Professional Standards for Teachers</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Reporting Violations</h2>
            <p className="text-[#374151] leading-relaxed">
              ...
              <a href="mailto:conduct@globalonlineyogaassociation.org" className="text-[#4E87A0] hover:underline">conduct@globalonlineyogaassociation.org</a>.
            </p>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Consequences</h2>
            <p className="text-[#374151] leading-relaxed">
