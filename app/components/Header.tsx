...
function UserMenu({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        {displayAvatar ? (
          <img src={displayAvatar} alt="" className={`w-7 h-7 rounded-full object-cover shrink-0 ${isImpersonating ? 'ring-2 ring-amber-500' : isSchoolContext ? 'ring-2 ring-[var(--goya-primary)]' : ''}`} />
        ) : (
          <div className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 ${isImpersonating ? 'bg-amber-500' : isSchoolContext ? 'bg-[var(--goya-primary)]' : 'bg-[#4E87A0]'}`}>
      ...
      {open && (
        <Dropdown>
          ...
          <div className="px-4 py-4 border-b border-[#E5E7EB] flex items-center gap-3">
            {displayAvatar ? (
              <img src={displayAvatar} alt="" className={`w-10 h-10 rounded-full object-cover shrink-0 ${isImpersonating ? 'ring-2 ring-amber-500' : isSchoolContext ? 'ring-2 ring-[var(--goya-primary)]' : ''}`} />
            ) : (
              <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${isImpersonating ? 'bg-amber-500' : isSchoolContext ? 'bg-[var(--goya-primary)]' : 'bg-[#4E87A0]'}`}>
                ...
                availableSchools.map(school => (
                  ...
                  >
                    {school.logo_url ? (
                      ...
                      <div className="w-6 h-6 rounded-full bg-[var(--goya-primary)] flex items-center justify-center shrink-0">
    ...
    <header className={`fixed ${isImpersonating ? 'top-10' : 'top-0'} left-0 right-0 z-50 bg-white border-b border-[#E5E7EB] shadow-sm`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          {/* Mobile controls: search + hamburger + avatar/login */}
              ...
              return (
                <>
                  <div className="px-5 py-4 border-b border-[#E5E7EB] flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${isImpersonating ? 'bg-amber-500' : mobileIsSchool ? 'bg-[var(--goya-primary)]' : 'bg-[#4E87A0]'}`}>
