    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {items.map((item) => {
          const className =
            formatType === 'format'
              ? `rounded-full px-3 py-1 text-sm font-medium ${FORMAT_COLORS[item] ?? 'bg-[#6E88B0]/10 text-[#6E88B0]'}`
              : 'rounded-full bg-[#6E88B0]/10 text-[#6E88B0] px-3 py-1 text-sm font-medium';
          return (
