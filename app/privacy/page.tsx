export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero */}
      <div className="bg-[#1B3A5C] pt-24 pb-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-3">Privacy Policy</h1>
          <p className="text-[#A8C5D8] text-lg">Last updated: March 2026</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 pb-24">
        <div className="prose-custom space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Introduction</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Information We Collect</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">How We Use Your Information</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Sharing of Information</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Data Retention</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Your Rights</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Changes to This Policy</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Contact Us</h2>
            <p className="text-[#374151] leading-relaxed">
              If you have questions about this Privacy Policy or your personal data, please contact us
              at <a href="mailto:privacy@globalonlineyogaassociation.org" className="text-[#4E87A0] hover:underline">privacy@globalonlineyogaassociation.org</a>.
            </p>
          </section>
