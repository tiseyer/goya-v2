...
export default function EventSidebarClient({
  ...
  return (
    <div className="sticky top-24 bg-white rounded-2xl border border-slate-200/80 shadow-lg p-6 space-y-5">
      ...
      <div>
        {event.is_free ? (
          <span className="inline-block px-3 py-1 bg-[var(--goya-primary)] text-white text-sm font-bold rounded-full">
            Free
          </span>
        ) : (
        ...
        <div>
          {event.external_registration && event.event_website ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full text-center py-3.5 px-6 bg-[var(--goya-primary)] hover:bg-[var(--goya-primary-dark)] text-white font-bold rounded-xl transition-colors duration-200 shadow-sm hover:shadow-md"
            >
              Register Externally
            </a>
          ) : event.is_free ? (
            <button
              ...
              className="block w-full text-center py-3.5 px-6 bg-[var(--goya-primary)] hover:bg-[var(--goya-primary-dark)] text-white font-bold rounded-xl transition-colors duration-200 shadow-sm hover:shadow-md disabled:opacity-60 cursor-pointer"
            >
            ...
            <button
              ...
              className="block w-full text-center py-3.5 px-6 bg-[var(--goya-primary)] hover:bg-[var(--goya-primary-dark)] text-white font-bold rounded-xl transition-colors duration-200 shadow-sm hover:shadow-md cursor-pointer"
            >
