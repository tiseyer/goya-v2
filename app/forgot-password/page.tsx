    ...
    <div className="h-screen overflow-hidden flex items-center justify-center px-4 bg-[#f8f9fa]">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 border border-[var(--goya-border)] shadow-sm">
          ...
          {sent ? (
            <div className="text-center py-4">
              <div className="w-16 h-16 bg-[var(--goya-primary)] rounded-full flex items-center justify-center mx-auto mb-5">
              ...
              <button
                ...
                className="text-[var(--goya-primary)] text-sm font-semibold hover:underline"
              >
        ...
        <p className="text-center text-slate-400 text-xs mt-6">
          <Link href="/sign-in" className="text-[var(--goya-primary)] hover:underline font-semibold">
