    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-[#1B3A5C] pt-24 pb-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#A8C5D8] text-lg">The ethical principles that guide GOYA teachers and practitioners.</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 pb-24">
        <div className="space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Integrity in Teaching</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Student Safety and Boundaries</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Honest Representation of Credentials</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Continuing Education Commitment</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Accountability</h2>
            <p className="text-[#374151] leading-relaxed">
            ...
            <p className="text-[#374151] leading-relaxed">
              ...
              <a href="mailto:ethics@globalonlineyogaassociation.org" className="text-[#4E87A0] hover:underline">ethics@globalonlineyogaassociation.org</a>.
