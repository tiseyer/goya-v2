      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 pb-24">
        <div className="space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Acceptance of Terms</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Use of the Platform</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">User Content</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Intellectual Property</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Disclaimers and Limitation of Liability</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Changes to These Terms</h2>
            <p className="text-[#374151] leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[#1B3A5C]">Contact</h2>
            <p className="text-[#374151] leading-relaxed">
              For questions about these Terms of Use, please contact us at{' '}
              <a href="mailto:legal@globalonlineyogaassociation.org" className="text-[#4E87A0] hover:underline">legal@globalonlineyogaassociation.org</a>.
            </p>
          </section>
