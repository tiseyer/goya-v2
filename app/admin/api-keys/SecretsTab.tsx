              ...
              <tbody className="divide-y divide-[#F1F5F9]">
                {filtered.map((secret) => (
                  <tr key={secret.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      {secret.has_value ? (
                        <span className="inline-block text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700">Set</span>
                      ) : (
                        <span className="inline-block text-[10px] font-semibold px-2 py-0.5 rounded-full bg-slate-100 text-slate-500">Not set</span>
                      )}
                    </td>
