...
export default async function RootLayout({
  ...
  const hideFooter = pathname.startsWith("/maintenance") || pathname.startsWith("/members") || pathname.startsWith("/sign-in") || pathname.startsWith("/forgot-password") || pathname.startsWith("/register") || pathname.startsWith("/login");
